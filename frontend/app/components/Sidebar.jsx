...
export default function Sidebar() {
    ...
    // href와 현재 경로 비교해서 active 클래스 결정
    const navClass = (href) =>
        ...
        <>
            <aside className="sidebar">
                ...
                <nav className="nav">
                    ...
                    <a className={navClass('/market-analysis')} href="#" onClick={(e) => handleNavClick(e, '/market-analysis')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <a className={navClass('/ai-insight')} href="#" onClick={(e) => handleNavClick(e, '/ai-insight')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <a className={navClass('/event-detection')} href="#" onClick={(e) => handleNavClick(e, '/event-detection')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                            <path d="M2 12l3-4 3 2 3-5 3 3"/><rect x="1" y="1" width="14" height="14" rx="2"/>
                        </svg>
                        이벤트 감지
                    </a>
                    <a className={navClass('/correlation')} href="#" onClick={(e) => handleNavClick(e, '/correlation')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <a className={navClass('/backtest')} href="#" onClick={(e) => handleNavClick(e, '/backtest')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                            <rect x="1" y="3" width="14" height="10" rx="1.5"/><path d="M5 3V1M11 3V1M1 7h14"/>
                        </svg>
                        백테스팅
                    </a>
                    <a className={navClass('/simulator')} href="#" onClick={(e) => handleNavClick(e, '/simulator')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <a className={navClass('/community')} href="#" onClick={(e) => handleNavClick(e, '/community')}>
                        <svg className="nav-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
